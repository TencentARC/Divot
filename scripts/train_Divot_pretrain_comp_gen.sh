...
NODE_RANK=$1
torchrun --nproc_per_node=8 --nnodes=4 --master_addr=11.220.5.202 --master_port=23457 --node_rank=$NODE_RANK \
    ...
    --llm_model ${PROJ_PATH}/configs/clm_models/mistral7b_lora.yaml \
    --agent_model ${PROJ_PATH}/configs/clm_models/agent_7b_in64_out64_video_gmm.yaml \
    --train_dataset ${PROJ_PATH}/configs/data/clm_pretrain_multi_data_video_comp_gen.yaml \
