...
torchrun --nproc_per_node=8 --nnodes=2 --master_addr=11.220.5.202 --master_port=23457 --node_rank=$NODE_RANK \
    ...
    --agent_model ${PROJ_PATH}/configs/clm_models/agent_7b_in64_out64_video_gmm_pretrain_comp.yaml \
    --train_dataset ${PROJ_PATH}/configs/data/clm_sft_multi_data_video_comp.yaml \
