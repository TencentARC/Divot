...
class AttentionMaskConverter:
    ...
    def _make_causal_mask(
        ...
        ### hardcore for bidirectional attention
        ...
        for i in range(bsz):
            ...
            if len(indx_i_list) > 0:
                image_start_indices = indx_i_list[::num_visual_tokens]  
                for start_idx in image_start_indices:
                    end_idx = start_idx + num_visual_tokens -1  
                    if end_idx < tgt_len:
                        new_mask[i, start_idx:end_idx+1, start_idx:end_idx+1] = 0
